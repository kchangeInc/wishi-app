# shared/repository/favourite.py
"""Favourite + RemovedMatch repository"""
...
class FavouriteRepository:
    ...
    def get_favourite_match_ids(self, user_id: int, wishlist_id: int = None) -> set:
    ...
    def get_dismissed_match_ids(self, user_id: int, wishlist_id: int = None) -> set:
