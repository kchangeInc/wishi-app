# shared/repository/pg/user.py
"""PostgreSQL user repository - handles user CRUD operations"""
...
class PgUserRepository(PgBaseRepository[User], IUserRepository):
    """PostgreSQL user-specific repository"""
