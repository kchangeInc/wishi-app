# shared/repository/pg/wishlist.py
"""PostgreSQL wishlist repository - handles all wishlist CRUD operations"""
...
class PgWishlistRepository(PgBaseRepository[Wishlist], IWishlistRepository):
    """PostgreSQL wishlist-specific repository with custom queries"""
